...
function add()  {
    /*this taks the inputed task and creates a variable of it*/
...
function remove() {
    var todos = get_todos();
    var id_number = this.getAttribute('id');
    todos.splice(id_number,1);
    localStorage.setItem('todo', JSON.stringify(todos));
    show();
...
//this tells browser how to display the todo array after an item has been removed
